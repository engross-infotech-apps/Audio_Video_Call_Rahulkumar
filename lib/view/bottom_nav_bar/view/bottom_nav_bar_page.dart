...
class _BottomNavBarPageState extends State<BottomNavBarPage> {
  final BottomNavBarController cntrl =
      Get.put(BottomNavBarController(), tag: "bottomNavBar");
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Padding(
          ...
          // EdgeInsets.fromLTRB(0, Platform.isAndroid ? 20 : 5, 0, 20),
          child: Row(children: [
            Expanded(
              child: Obx(() => Text(
              ...
              () => GestureDetector(
                onTap: () async {
                  if (cntrl.selectedIndex.value == 2) {
                    ...
                    //   showLookupBottomSheet(child: RatingReviewFilter());
                  } else if (cntrl.selectedIndex.value == 3) {
                    await bookMarkOnTap();
                    setState(() {});
                  }
                        ...
                        children: [
                          Container(
                            ...
                            child: Custom.svgIconData(
                                cntrl.selectedIndex.value == 2
                                    ? AppSvgIcons.donorFill
                                    : AppSvgIcons.donorBorder,
                                size: 35,
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          color: cntrl.selectedIndex.value == 4
                                              ? AppColors.primaryRed
