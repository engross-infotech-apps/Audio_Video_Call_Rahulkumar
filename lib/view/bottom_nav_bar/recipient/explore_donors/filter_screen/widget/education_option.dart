...
class EducationView extends StatefulWidget {
  ...
  @override
  State<EducationView> createState() => EducationList();
}

class EducationList extends State<EducationView> {
  var all = false;
                        ...
                        child: Row(
                            ...
                            children: [
                              widget.lookupList[index].image != null
                                  ...
                                  : SizedBox(),
                              widget.lookupList[index].code != null
                                  ? Row(
                                      children: [
                                        Text(
                                          countryCodeToEmoji(
                                              widget.lookupList[index].code!),
