...
class BloodGroupView extends StatefulWidget {
  const BloodGroupView({
    super.key,
  ...
  @override
  State<BloodGroupView> createState() => BloodGroup();
}

class BloodGroup extends State<BloodGroupView> {
