...
class HairColorView extends StatefulWidget {
  const HairColorView({
    super.key,
  ...
  @override
  State<HairColorView> createState() => HairColorList();
}

class HairColorList extends State<HairColorView> {
